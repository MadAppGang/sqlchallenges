...
import { mockChallenges, executeSqlQuery } from './data/mockChallenges';
...
export default function App() {
  ...
  const currentChallenge = mockChallenges.find(c => c.id === currentChallengeId);
      ...
      <div className="border-b border-border bg-card">
        <div className="flex items-center justify-between p-4">
          <div className="flex items-center gap-4">
            ...
            <Select value={currentChallengeId.toString()} onValueChange={handleChallengeSelect}>

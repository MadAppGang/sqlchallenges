		...
		tables: [
			{
				...
				columns: [
					...
					{ name: "email", type: "VARCHAR(100)", description: "Email (unique)" },
		...
		tables: [
			{
				...
				columns: [
					...
					{ name: "category_name", type: "VARCHAR(100)", description: "Category name" },
		...
		tables: [
			{
				...
				columns: [
					{ name: "order_id", type: "INT", description: "Primary key" },
					{ name: "customer_id", type: "INT", description: "Foreign key to customers" },
					{ name: "total_amount", type: "DECIMAL(10,2)", description: "Recorded total" },
				],
				sampleData: [],
			},
			{

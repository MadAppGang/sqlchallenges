...
const CodeEditor: React.FC<CodeEditorProps> = ({
  ...
  const sqlKeywords = [
    ...
    'GROUP', 'BY', 'ORDER', 'HAVING', 'DISTINCT', 'AS', 'AND', 'OR', 'NOT',
...
SELECT * FROM customers;"
        ...
        <div className="px-4 pb-4 pt-2 text-xs text-muted-foreground border-t border-border">
          Press <kbd className="px-1.5 py-0.5 bg-muted rounded text-xs">Ctrl+Enter</kbd> to run query • <kbd className="px-1.5 py-0.5 bg-muted rounded text-xs">Tab</kbd> to indent
        </div>
      </CardContent>
    </Card>
  );
